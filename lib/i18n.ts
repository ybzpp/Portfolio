...
export const translations = {
  ru: {
    ...
    about: {
      ...
      experience: 'Опыт',
      bio: 'Unity-разработчик с более чем 5 годами опыта в игровой индустрии. Глубокие знания Unity, C# и мультиплеерной разработки. Работал над match-3, гипер-казуалом и мультиплеером (до 32 игроков). Сотрудничал с паблишерами Voodoo, Supersonic, Ducky. Несколько лет в роли лида: повышение эффективности команды, собеседования и найм. Создаю рекламные креативы и Playable Ads.',
      timeline: [
